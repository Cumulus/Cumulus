...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7db565264d222f6a4f7d8f9d979b4c0a) *)
(*
...
let setup_t =
  {
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("macaque.syntax", None);
                           FindlibPackage ("batteries", None);
                           FindlibPackage ("lwt.syntax", None);
                           FindlibPackage ("safepass", None)
                        ];
                 ...
                 ({
                     ...
                     },
                   {
                      ...
                      bs_data_files =
                        [
                           ("data/*", Some "/tmp");
                           ("_build/src/_client/cumulus.js", Some "/tmp")
                        ];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\208{\168\192\171L\184\020\152\195O2@\189\186\160";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
