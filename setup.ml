...
(* OASIS_START *)
(* DO NOT EDIT (digest: 87a679693bfb1ad4d9040307317ca6c7) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.4.1";
     oasis_digest =
       Some "\132\018\026\206\002\188< &\137\208\153\183\195\128\161";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
...
let () =
  ...
  let check_msg = function
    ...
    | "Cannot find source file matching module 'server/Templates_feeds' in library cumulus" ->
        true
    | _ -> false
  in
  let def = !default in
