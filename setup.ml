...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7e72b584ebcbe7c530c6072d52d0992f) *)
(*
...
let setup_t =
  {
                 ...
                 ({
                     ...
                     },
                   {
                      ...
                      bs_data_files =
                        [
                           ("data/*", None);
                           ("_build/src/_client/cumulus.js", None)
                        ];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["src/_client/Templates"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\207\201\254\149\244\027\182\196k\201-O]\218'\186";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
