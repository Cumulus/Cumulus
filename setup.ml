...
(* OASIS_START *)
(* DO NOT EDIT (digest: 39da82fd32930c39ff4391cf1047aa64) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         {
            OCamlbuildPlugin.plugin_tags = Some "package(eliom.ocamlbuild)";
            extra_args = [];
            };
     test = [];
     doc = [];
            ...
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("macaque_lwt", None);
                           FindlibPackage
                             ("pgocaml",
                               Some (OASISVersion.VGreaterEqual "1.7"));
                           FindlibPackage
                             ("lwt.syntax",
                               Some (OASISVersion.VGreaterEqual "2.4"));
                           FindlibPackage
                             ("safepass",
                   ...
                   {
                      lib_modules = ["Db_update"; "Db"; "Db_feed"; "Db_user"];
                      lib_pack = false;
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "base"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files =
                        [
                   ...
                   {
                      lib_modules = ["server/Templates"; "Main"];
                      lib_pack = false;
                      lib_internal_modules = [];
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\134\149d\198\230\n\238\183\215MMtY\024\028\186";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
...
let () =
  ...
  let check_msg = function
    | "Cannot find source file matching module 'server/Templates' in library cumulus" ->
        true
    | _ -> false
  in
  let def = !default in
